...
task test-coverage  # run tests with coverage report (fails below adjusted 75%)
...
- **75% adjusted coverage minimum** enforced by CI; prioritize meaningful behavioral coverage over percentage chasing
